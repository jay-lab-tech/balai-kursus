...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold text-dark mb-0"><i class="bi bi-pencil-square me-2"></i>Edit Peserta</h2>
        ...
        <div class="card-body">
            <form action="/admin/peserta/{{ $peserta->id }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" class="form-control" value="{{ old('email', $peserta->user->email ?? '') }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="instansi" class="form-control" value="{{ old('instansi', $peserta->instansi) }}">
                </div>
